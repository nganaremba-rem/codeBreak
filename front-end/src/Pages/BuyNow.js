    ...
    <>
      ...
      <div className="main-wrapper mt-3 mb-4 d-flex justify-content-center ">
        <div className="orders shadow rounded-3 p-4 w-75">
          <h4 className="bg-info p-4 text-white">Summary</h4>
          ...
          <div className="delivery-address mt-5">
            <h4 className="bg-secondary p-4 text-white">Delivery Address</h4>
          ...
          <h4 className="mt-5 bg-success p-4 text-white">Payment</h4>
